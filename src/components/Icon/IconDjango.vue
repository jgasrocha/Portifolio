...
<style scoped>
/* Opcional: Estilos para controlar a cor e o tamanho */
.django-icon-svg {
  width: 100%;
  height: 100%;
  /* A propriedade 'fill' aqui pode ser substituída pela cor que você passa no 'Home.vue' */
  /* fill: #092E20; */ 
}
</style>