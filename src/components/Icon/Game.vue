    ...
    <svg viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000">
        ...
        <g id="SVGRepo_iconCarrier">
            ...
            <path
                ...
                fill="#2c3e50"></path>
            <path d="M322.4 594.8m-98.1 0a98.1 98.1 0 1 0 196.2 0 98.1 98.1 0 1 0-196.2 0Z" fill="#ff6b6b"></path>
            <path
                ...
                fill="#2c3e50"></path>
            <path d="M702.4 594.8m-98.1 0a98.1 98.1 0 1 0 196.2 0 98.1 98.1 0 1 0-196.2 0Z" fill="#ff6b6b"></path>
            <path
                ...
                fill="#2c3e50"></path>
            <path d="M511 497.9m-45.2 0a45.2 45.2 0 1 0 90.4 0 45.2 45.2 0 1 0-90.4 0Z" fill="#ff6b6b"></path>
            <path
            ...
            <path
                ...
                fill="#2c3e50"></path>
            <path d="M805.3 243.4m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#2c3e50"></path>
            <path d="M805.3 402.2m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#2c3e50"></path>
            <path d="M884.7 322.8m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#2c3e50"></path>
            <path d="M725.8 322.8m-33.3 0a33.3 33.3 0 1 0 66.6 0 33.3 33.3 0 1 0-66.6 0Z" fill="#2c3e50"></path>
        </g>
    </svg>
</template>