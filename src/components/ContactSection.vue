            ...
            <div class="contact-content">
                <div class="contact-info">
                    <div class="logo-container">
                        <img src="../../assets/logo.png" alt="Logo João Gabriel" class="logo">
                    </div>
                    <p class="info-text">Se você tem uma ideia, um projeto em mente ou apenas quer bater um papo sobre
                        tecnologia, sinta-se à vontade para me enviar uma mensagem. Estou sempre aberto a novas
                        oportunidades e colaborações!</p>
                </div>
                <div class="contact-form">
                    <form ref="contactForm" @submit.prevent="submitForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="subject" name="_subject" v-model="form.subject" required>
                        </div>
                        <div class="form-group">
                        ...
                        <input type="hidden" name="_next" value="http://sua-pagina.com/obrigado.html">
...
export default {
    ...
    methods: {
        async submitForm() {
            const formUrl = "https://formsubmit.co/gabrieldeveloper33@gmail.com";
